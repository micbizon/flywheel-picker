...
PROMPT_PATH = Path(__file__).parent.parent.parent / "prompts" / "system" / "feedback_loop.md"
...
def run_feedback(decision: dict, current_data: dict, months: int) -> dict:
    ...
    prompt = (
        ...
        .replace("[CURRENT_DATA]", json.dumps(current_data, ensure_ascii=False, indent=2))
